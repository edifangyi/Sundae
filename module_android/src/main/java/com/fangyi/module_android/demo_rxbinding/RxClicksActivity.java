 ...
 * ================================================
 */
public class RxClicksActivity extends BaseToolbarActivity {
    ...
    public static void startAction(Activity activity, boolean isFinish, String title) {
        Intent intent = new Intent(activity, RxClicksActivity.class);
    ...
    protected int getLayoutId() {
        return R.layout.activity_rx_clicks;
    }
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        RxView.clicks(mBtnClicks)
                ...
                .subscribe(c -> {
                    ...
                    textView.setText(" 点击了 ==> " + System.currentTimeMillis());
